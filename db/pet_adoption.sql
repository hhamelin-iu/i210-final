...
Is Almano the furry friend you''ve been searching for? Apply to adopt today!', 'Playful, energetic, and loves interactive toys.', 'img/animals/cats/glooble.jpg', 'Available'),
...
Ready to welcome Ah So Cat into your life? Contact our adoption team now.', 'Gentle, quiet, and enjoys lounging in sunny spots.', 'img/animals/cats/ah_so_cat.png', 'Available'),
...
Artyom is dreaming of a cozy lap and plenty of treats in a quiet, loving home.', 'Playful, Goofy, High-energy', 'img/animals/cats/artyom.png', 'Available'),
...
Angelina is ready to start their next chapter with a devoted family.', 'Curious, alert, and always exploring their surroundings.', 'img/animals/cats/angelina.png', 'Available'),
...
Come say hello to Aoba and give this special pet the loving home they deserve.', 'Gentle-natured, Kind-hearted, Affectionate', 'img/animals/cats/aoba.png', 'Available'),
...
Don''t miss the chance to bring Baguette Dude home—fill out an adoption inquiry today.', 'Mellow, relaxed, and great with cozy lap naps.', 'img/animals/cats/baguette_dude.png', 'Available'),
...
Give Baskit Cat the fresh start they''ve been waiting for!', 'Social, confident, and eager to welcome visitors.', 'img/animals/cats/baskit_cat.png', 'Available'),
...
Bat Cat would love to meet you—schedule a visit and fall in love!', 'Sweet-tempered, loyal, and thrives in a peaceful environment.', 'img/animals/cats/bat_cat.png', 'Available'),
...
Big Billy is up to date on vaccinations and ready to head home with you!', 'Gentle-natured, Kind-hearted, Affectionate', 'img/animals/cats/big_billy.png', 'Available'),
...
Could Ben be the missing piece in your family? Come meet them today!', 'Gentle-natured, Kind-hearted, Affectionate', 'img/animals/cats/ben.png', 'Available'),
...
Is Bentley the furry friend you''ve been searching for? Apply to adopt today!', 'Gentle-natured, Kind-hearted, Affectionate (Farming)', 'img/animals/cats/bentley.png', 'Available'),
...
Ready to welcome Bernard into your life? Contact our adoption team now.', 'Playful, Goofy, High-energy', 'img/animals/cats/bernard.png', 'Available'),
...
Bb is dreaming of a cozy lap and plenty of treats in a quiet, loving home.', 'Spirited, independent, but very loving with their favorite human.', 'img/animals/cats/bb.png', 'Available'),
...
Billy is ready to start their next chapter with a devoted family.', 'Mellow, relaxed, and great with cozy lap naps.', 'img/animals/cats/billy.png', 'Available'),
...
Come say hello to Bingus and give this special pet the loving home they deserve.', 'Social, confident, and eager to welcome visitors.', 'img/animals/cats/bingus.png', 'Available'),
...
Don''t miss the chance to bring BOB of Bobstein home—fill out an adoption inquiry today.', 'Sweet-tempered, loyal, and thrives in a peaceful environment.', 'img/animals/cats/glooble.jpg', 'Available'),
...
Give Bingus/Bingus the II the fresh start they''ve been waiting for!', 'Gentle-natured, Kind-hearted, Affectionate', 'img/animals/cats/bingus_bingus_the_ii.png', 'Available'),
...
Bleg would love to meet you—schedule a visit and fall in love!', 'Gentle-natured, Kind-hearted, Affectionate', 'img/animals/cats/bleg.png', 'Available'),
...
Bleemk is up to date on vaccinations and ready to head home with you!', 'Affectionate, purr-heavy cuddlebug who loves head scratches.', 'img/animals/cats/bleemk.png', 'Available'),
...
Could Bob be the missing piece in your family? Come meet them today!', 'Curious, alert, and always exploring their surroundings.', 'img/animals/cats/bob.png', 'Available'),
(21, 'Bounty hunter cat', 2, 12, 7, 'Looking for a cuddle buddy? Bounty hunter cat might just be your perfect match!

Bounty hunter cat

Is Bounty hunter cat the furry friend you''ve been searching for? Apply to adopt today!', 'Spirited, independent, but very loving with their favorite human.', 'img/animals/cats/bounty_hunter_cat.png', 'Available'),
...
Ready to welcome Brunnincast into your life? Contact our adoption team now.', 'Playful, Goofy, High-energy', 'img/animals/cats/brunnincast.png', 'Available'),
...
Bubble Cat is dreaming of a cozy lap and plenty of treats in a quiet, loving home.', 'Social, confident, and eager to welcome visitors.', 'img/animals/cats/bubble_cat.png', 'Available'),
...
Buck is ready to start their next chapter with a devoted family.', 'Sweet-tempered, loyal, and thrives in a peaceful environment.', 'img/animals/cats/buck.png', 'Available'),
...
Come say hello to Bungus and give this special pet the loving home they deserve.', 'Playful, Goofy, High-energy (Judging who goes to heck and who goes to not heck<br>)', 'img/animals/cats/bungus.png', 'Available'),
...
Don''t miss the chance to bring Cala home—fill out an adoption inquiry today.', 'Gentle, quiet, and enjoys lounging in sunny spots.', 'img/animals/cats/cala.png', 'Available'),
...
Give Cheeseburger the fresh start they''ve been waiting for!', 'Affectionate, purr-heavy cuddlebug who loves head scratches.', 'img/animals/cats/cheeseburger.png', 'Available'),
...
Cement Joe would love to meet you—schedule a visit and fall in love!', 'Curious, alert, and always exploring their surroundings.', 'img/animals/cats/cement_joe.png', 'Available'),
(29, 'Canela', 2, 13, 7, 'Canela is a precious soul ready for their next big chapter in a forever home.

- EtharViolo Canela

Canela is up to date on vaccinations and ready to head home with you!', 'Spirited, independent, but very loving with their favorite human.', 'img/animals/cats/canela.png', 'Available'),
...
Could Chipi Chipi Chapa Chapa Cat be the missing piece in your family? Come meet them today!', 'Mellow, relaxed, and great with cozy lap naps.', 'img/animals/cats/chipi_chipi_chapa_chapa_cat.png', 'Available'),
...
Is Cokey Cola the furry friend you''ve been searching for? Apply to adopt today!', 'Social, confident, and eager to welcome visitors.', 'img/animals/cats/cokey_cola.png', 'Available'),
...
Ready to welcome Cuh into your life? Contact our adoption team now.', 'Sweet-tempered, loyal, and thrives in a peaceful environment.', 'img/animals/cats/cuh.png', 'Available'),
...
Deksy is dreaming of a cozy lap and plenty of treats in a quiet, loving home.', 'Playful, energetic, and loves interactive toys.', 'img/animals/cats/deksy.png', 'Available'),
...
Demetrus P. Dinklebottom is ready to start their next chapter with a devoted family.', 'Charismatic, Confident, Leader (Crime Boss)', 'img/animals/cats/demetrus_p__dinklebottom.png', 'Available'),
...
Come say hello to Cwawa and give this special pet the loving home they deserve.', 'Affectionate, purr-heavy cuddlebug who loves head scratches.', 'img/animals/cats/cwawa.png', 'Available'),
...
Don''t miss the chance to bring Demon Cat home—fill out an adoption inquiry today.', 'Playful, Goofy, High-energy', 'img/animals/cats/demon_cat.png', 'Available'),
...
Give Demonic Little Grey Cat the fresh start they''ve been waiting for!', 'Gentle-natured, Kind-hearted, Affectionate', 'img/animals/cats/demonic_little_grey_cat.png', 'Available'),
(38, 'Dietzen D. Dinklebottom', 2, 9, 6, 'Give a warm welcome to Dietzen D. Dinklebottom, an adventurous and spirited friend.

Dinklebottom

Dietzen D. Dinklebottom would love to meet you—schedule a visit and fall in love!', 'Mellow, relaxed, and great with cozy lap naps.', 'img/animals/cats/dietzen_d__dinklebottom.png', 'Available'),
(39, 'Dmitri', 2, 8, 2, 'Dmitri is ready to make your house feel like home.

Diechmen Family Vampirius Dmitri Skeletus Ramses Dmitri

Dmitri is up to date on vaccinations and ready to head home with you!', 'Social, confident, and eager to welcome visitors.', 'img/animals/cats/dmitri.png', 'Available'),
...
Could Doobis be the missing piece in your family? Come meet them today!', 'Sweet-tempered, loyal, and thrives in a peaceful environment.', 'img/animals/cats/doobis.png', 'Available'),
...
Is Dr Pebba the furry friend you''ve been searching for? Apply to adopt today!', 'Playful, energetic, and loves interactive toys.', 'img/animals/cats/dr_pebba.png', 'Available'),
...
Ready to welcome Dr Peppy into your life? Contact our adoption team now.', 'Gentle, quiet, and enjoys lounging in sunny spots.', 'img/animals/cats/dr_peppy.png', 'Available'),
...
Drefis is dreaming of a cozy lap and plenty of treats in a quiet, loving home.', 'Affectionate, purr-heavy cuddlebug who loves head scratches.', 'img/animals/cats/drefis.png', 'Available'),
...
Dr. Silly Willy is ready to start their next chapter with a devoted family.', 'Playful, Goofy, High-energy', 'img/animals/cats/dr__silly_willy.png', 'Available'),
...
Come say hello to Doudou(Oye) and give this special pet the loving home they deserve.', 'Playful, Goofy, High-energy', 'img/animals/cats/doudou_oye.png', 'Available'),
(46, 'Drazy Cat', 2, 14, 2, 'Ready to open your heart? Drazy Cat is waiting to meet their forever family.

Drazy Cat nation

Don''t miss the chance to bring Drazy Cat home—fill out an adoption inquiry today.', 'Mellow, relaxed, and great with cozy lap naps.', 'img/animals/cats/drazy_cat.png', 'Available'),
...
Give El Gato the fresh start they''ve been waiting for!', 'Social, confident, and eager to welcome visitors.', 'img/animals/cats/el_gato.png', 'Available'),
...
E. Scrunk would love to meet you—schedule a visit and fall in love!', 'Sweet-tempered, loyal, and thrives in a peaceful environment.', 'img/animals/cats/e__scrunk.png', 'Available'),
...
Edward is up to date on vaccinations and ready to head home with you!', 'Playful, energetic, and loves interactive toys.', 'img/animals/cats/edward.png', 'Available'),
...
Could Eepeer (Endless Eeps) be the missing piece in your family? Come meet them today!', 'Sleepy, Cuddly, Mellow', 'img/animals/cats/eepeer__endless_eeps.png', 'Available'),
...
Is Evil Cat the furry friend you''ve been searching for? Apply to adopt today!', 'Gentle-natured, Kind-hearted, Affectionate (Community Companion)', 'img/animals/cats/evil_cat.png', 'Available'),
...
Ready to welcome Ernesto into your life? Contact our adoption team now.', 'Curious, alert, and always exploring their surroundings.', 'img/animals/cats/ernesto.png', 'Available'),
...
Ethel the Cat is dreaming of a cozy lap and plenty of treats in a quiet, loving home.', 'Playful, Goofy, High-energy', 'img/animals/cats/ethel_the_cat.png', 'Available'),
...
Fanter is ready to start their next chapter with a devoted family.', 'Mellow, relaxed, and great with cozy lap naps.', 'img/animals/cats/fanter.png', 'Available'),
...
Come say hello to Ferret and give this special pet the loving home they deserve.', 'Social, confident, and eager to welcome visitors.', 'img/animals/cats/ferret.png', 'Available'),
...
Don''t miss the chance to bring Eyebrow home—fill out an adoption inquiry today.', 'Sweet-tempered, loyal, and thrives in a peaceful environment.', 'img/animals/cats/eyebrow.png', 'Available'),
...
Give Floppa the fresh start they''ve been waiting for!', 'Gentle-natured, Kind-hearted, Affectionate (Community Companion)', 'img/animals/cats/floppa.png', 'Available'),
(58, 'Ethan', 2, 7, 7, 'Ethan has arrived at the shelter and is eager to meet their new best friend.

Ethan muehehe...

Ethan would love to meet you—schedule a visit and fall in love!', 'Playful, Goofy, High-energy', 'img/animals/cats/ethan.png', 'Available'),
...
Future Kitty is up to date on vaccinations and ready to head home with you!', 'Gentle-natured, Kind-hearted, Affectionate (Time Traveling<br>)', 'img/animals/cats/future_kitty.png', 'Available'),
...
Could Gentleman be the missing piece in your family? Come meet them today!', 'Charismatic, Confident, Leader', 'img/animals/cats/gentleman.png', 'Available'),
...
Is Gangster bob the furry friend you''ve been searching for? Apply to adopt today!', 'Playful, Goofy, High-energy', 'img/animals/cats/gangster_bob.png', 'Available'),
...
Ready to welcome Geeble into your life? Contact our adoption team now.', 'Playful, Goofy, High-energy (Being an alien doing alien things.)', 'img/animals/dogs/geeble.png', 'Available'),
...
Glombie is dreaming of a cozy lap and plenty of treats in a quiet, loving home.', 'Social, confident, and eager to welcome visitors.', 'img/animals/dogs/glombie.png', 'Available'),
...
Fouet is ready to start their next chapter with a devoted family.', 'Gentle-natured, Kind-hearted, Affectionate', 'img/animals/cats/fouet.png', 'Available'),
...
Come say hello to Gloober and give this special pet the loving home they deserve.', 'Playful, Goofy, High-energy', 'img/animals/cats/gloober.png', 'Available'),
...
Don''t miss the chance to bring Glungus home—fill out an adoption inquiry today.', 'Gentle, quiet, and enjoys lounging in sunny spots.', 'img/animals/cats/glungus.png', 'Available'),
...
Give Glorpo the fresh start they''ve been waiting for!', 'Playful, Goofy, High-energy', 'img/animals/cats/glorpo.png', 'Available'),
...
Gnapy would love to meet you—schedule a visit and fall in love!', 'Curious, alert, and always exploring their surroundings.', 'img/animals/cats/gnapy.png', 'Available'),
...
Glooble is up to date on vaccinations and ready to head home with you!', 'Spirited, independent, but very loving with their favorite human.', 'img/animals/cats/glooble.png', 'Available'),
...
Could Goga Cat be the missing piece in your family? Come meet them today!', 'Charismatic, Confident, Leader', 'img/animals/cats/goga_cat.png', 'Available'),
(71, 'Goober the Eighth', 2, 13, 4, 'Goober the Eighth is ready to make your house feel like home.

Goober the Eighth

Is Goober the Eighth the furry friend you''ve been searching for? Apply to adopt today!', 'Social, confident, and eager to welcome visitors.', 'img/animals/cats/goober_the_eighth.png', 'Available'),
(72, 'Goober the Fifth', 2, 13, 5, 'If you''re seeking a loyal and affectionate partner, look no further than Goober the Fifth.

Goober the fifth

Ready to welcome Goober the Fifth into your life? Contact our adoption team now.', 'Playful, Goofy, High-energy', 'img/animals/cats/goober_the_fifth.png', 'Available'),
...
Goober the Ninth is dreaming of a cozy lap and plenty of treats in a quiet, loving home.', 'Playful, energetic, and loves interactive toys.', 'img/animals/cats/goober_the_ninth.png', 'Available'),
...
Goofus is ready to start their next chapter with a devoted family.', 'Gentle, quiet, and enjoys lounging in sunny spots.', 'img/animals/cats/goofus.png', 'Available'),
(75, 'Goober the Third', 2, 13, 1, 'With a majestic presence and a gentle heart, Goober the Third is waiting for you.

Goober the Third

Come say hello to Goober the Third and give this special pet the loving home they deserve.', 'Affectionate, purr-heavy cuddlebug who loves head scratches.', 'img/animals/cats/goober_the_third.png', 'Available'),
(76, 'Goober the Fourth', 2, 10, 7, 'Say hi to Goober the Fourth, a delightful pet who loves making new friends.

Goober the Fourth

Don''t miss the chance to bring Goober the Fourth home—fill out an adoption inquiry today.', 'Curious, alert, and always exploring their surroundings.', 'img/animals/cats/goober_the_fourth.png', 'Available'),
(77, 'Goober the Second', 2, 2, 7, 'Goober the Second is a precious soul ready for their next big chapter in a forever home.

Goober the Second

Give Goober the Second the fresh start they''ve been waiting for!', 'Spirited, independent, but very loving with their favorite human.', 'img/animals/cats/goober_the_second.png', 'Available'),
(78, 'Goober the Sixth', 2, 13, 1, 'Ready to open your heart? Goober the Sixth is waiting to meet their forever family.

Goober the Sixth

Goober the Sixth would love to meet you—schedule a visit and fall in love!', 'Mellow, relaxed, and great with cozy lap naps.', 'img/animals/cats/goober_the_sixth.png', 'Available'),
(79, 'Goober the Tenth', 2, 15, 2, 'Goober the Tenth is an extraordinary pet with a story to tell and plenty of love to give.

Goober the Tenth

Goober the Tenth is up to date on vaccinations and ready to head home with you!', 'Social, confident, and eager to welcome visitors.', 'img/animals/cats/goober_the_tenth.png', 'Available'),
...
Could Grinwatcher/Underling be the missing piece in your family? Come meet them today!', 'Sweet-tempered, loyal, and thrives in a peaceful environment.', 'img/animals/cats/grinwatcher_underling.png', 'Available'),
...
Is Grinwatcher the furry friend you''ve been searching for? Apply to adopt today!', 'Playful, Goofy, High-energy (Community Companion)', 'img/animals/cats/grinwatcher.png', 'Available'),
...
Ready to welcome Grumpy Cat into your life? Contact our adoption team now.', 'Playful, Goofy, High-energy (Thinking)', 'img/animals/cats/grumpy_cat.png', 'Available'),
...
Happy Cat is dreaming of a cozy lap and plenty of treats in a quiet, loving home.', 'Affectionate, purr-heavy cuddlebug who loves head scratches.', 'img/animals/cats/happy_cat.png', 'Available'),
...
Grinwatcher/Right Hand Smiles is ready to start their next chapter with a devoted family.', 'Curious, alert, and always exploring their surroundings.', 'img/animals/cats/grinwatcher_right_hand_smiles.png', 'Available'),
...
Come say hello to Gusic and give this special pet the loving home they deserve.', 'Spirited, independent, but very loving with their favorite human.', 'img/animals/cats/gusic.png', 'Available'),
...
Don''t miss the chance to bring Herbert home—fill out an adoption inquiry today.', 'Mellow, relaxed, and great with cozy lap naps.', 'img/animals/cats/herbert.png', 'Available'),
...
Give Hu Cat the fresh start they''ve been waiting for!', 'Social, confident, and eager to welcome visitors.', 'img/animals/cats/hu_cat.png', 'Available'),
...
Jocelin would love to meet you—schedule a visit and fall in love!', 'Sweet-tempered, loyal, and thrives in a peaceful environment.', 'img/animals/cats/jocelin.png', 'Available'),
...
Insam is up to date on vaccinations and ready to head home with you!', 'Playful, Goofy, High-energy (Archrival)', 'img/animals/cats/insam.png', 'Available'),
...
Could Juice Cat be the missing piece in your family? Come meet them today!', 'Charismatic, Confident, Leader', 'img/animals/cats/juice_cat.png', 'Available'),
...
Is Larry the furry friend you''ve been searching for? Apply to adopt today!', 'Gentle-natured, Kind-hearted, Affectionate', 'img/animals/cats/larry.png', 'Available'),
...
Ready to welcome Kiw into your life? Contact our adoption team now.', 'Playful, Goofy, High-energy (Community Companion)', 'img/animals/cats/kiw.png', 'Available'),
...
Kyky is dreaming of a cozy lap and plenty of treats in a quiet, loving home.', 'Playful, Goofy, High-energy', 'img/animals/cats/kyky.png', 'Available'),
...
Limecat is ready to start their next chapter with a devoted family.', 'Gentle-natured, Kind-hearted, Affectionate', 'img/animals/cats/limecat.png', 'Available'),
...
Come say hello to Juju Nugget and give this special pet the loving home they deserve.', 'Sleepy, Cuddly, Mellow', 'img/animals/cats/juju_nugget.png', 'Available'),
...
Don''t miss the chance to bring Luna the Tabby home—fill out an adoption inquiry today.', 'Sweet-tempered, loyal, and thrives in a peaceful environment.', 'img/animals/cats/luna_the_tabby.png', 'Available'),
...
Give Leonard the fresh start they''ve been waiting for!', 'Playful, Goofy, High-energy', 'img/animals/cats/leonard.png', 'Available'),
...
Maxwell would love to meet you—schedule a visit and fall in love!', 'Gentle-natured, Kind-hearted, Affectionate (Community Companion)', 'img/animals/cats/maxwell.png', 'Available'),
...
Meevin is up to date on vaccinations and ready to head home with you!', 'Affectionate, purr-heavy cuddlebug who loves head scratches.', 'img/animals/cats/meevin.png', 'Available'),
...
Could Monsert be the missing piece in your family? Come meet them today!', 'Curious, alert, and always exploring their surroundings.', 'img/animals/cats/monsert.png', 'Available'),
...
Is Nilbert the furry friend you''ve been searching for? Apply to adopt today!', 'Spirited, independent, but very loving with their favorite human.', 'img/animals/cats/nilbert.png', 'Available'),
...
Ready to welcome Neeble into your life? Contact our adoption team now.', 'Mellow, relaxed, and great with cozy lap naps.', 'img/animals/cats/neeble.png', 'Available'),
...
Mrs. Pringleton is dreaming of a cozy lap and plenty of treats in a quiet, loving home.', 'Gentle-natured, Kind-hearted, Affectionate', 'img/animals/cats/mrs__pringleton.png', 'Available'),
(104, 'Panko', 2, 14, 2, 'If you''re seeking a loyal and affectionate partner, look no further than Panko.

Description [ ] Panko

Panko is ready to start their next chapter with a devoted family.', 'Sweet-tempered, loyal, and thrives in a peaceful environment.', 'img/animals/cats/panko.png', 'Available'),
...
Come say hello to Pepsie and give this special pet the loving home they deserve.', 'Playful, Goofy, High-energy (Delivery)', 'img/animals/cats/pepsie.png', 'Available'),
...
Don''t miss the chance to bring Photosynthesizing home—fill out an adoption inquiry today.', 'Gentle, quiet, and enjoys lounging in sunny spots.', 'img/animals/cats/photosynthesizing.png', 'Available'),
...
Give Pobis the fresh start they''ve been waiting for!', 'Playful, Goofy, High-energy', 'img/animals/cats/pobis.png', 'Available'),
...
Poncky would love to meet you—schedule a visit and fall in love!', 'Curious, alert, and always exploring their surroundings.', 'img/animals/cats/poncky.png', 'Available'),
...
Potato is up to date on vaccinations and ready to head home with you!', 'Spirited, independent, but very loving with their favorite human.', 'img/animals/cats/potato.png', 'Available'),
(110, 'Prince bingulius', 2, 8, 3, 'Ready to open your heart? Prince bingulius is waiting to meet their forever family.

Prince Bingulius

Could Prince bingulius be the missing piece in your family? Come meet them today!', 'Charismatic, Confident, Leader', 'img/animals/cats/prince_bingulius.png', 'Available'),
...
Is Pusha the furry friend you''ve been searching for? Apply to adopt today!', 'Social, confident, and eager to welcome visitors.', 'img/animals/cats/pusha.png', 'Available'),
...
Ready to welcome Prongles into your life? Contact our adoption team now.', 'Playful, Goofy, High-energy (Failing to obey factory rule)', 'img/animals/cats/prongles.png', 'Available'),
...
Quetzkol The Incomprehensible Deity is dreaming of a cozy lap and plenty of treats in a quiet, loving home.', 'Playful, Goofy, High-energy (Being Incomprehensible)', 'img/animals/cats/quetzkol_the_incomprehensible_deity.png', 'Available'),
...
Radio Cat is ready to start their next chapter with a devoted family.', 'Playful, Goofy, High-energy', 'img/animals/cats/radio_cat.png', 'Available'),
...
Come say hello to Ramses and give this special pet the loving home they deserve.', 'Affectionate, purr-heavy cuddlebug who loves head scratches.', 'img/animals/cats/ramses.png', 'Available'),
...
Don''t miss the chance to bring Sandwich home—fill out an adoption inquiry today.', 'Playful, Goofy, High-energy (Community Companion)', 'img/animals/cats/sandwich.png', 'Available'),
...
Give Rigby the fresh start they''ve been waiting for!', 'Gentle-natured, Kind-hearted, Affectionate', 'img/animals/cats/rigby.png', 'Available'),
...
Roobeer would love to meet you—schedule a visit and fall in love!', 'Mellow, relaxed, and great with cozy lap naps.', 'img/animals/cats/roobeer.png', 'Available'),
...
Richer Motion is up to date on vaccinations and ready to head home with you!', 'Social, confident, and eager to welcome visitors.', 'img/animals/cats/richer_motion.png', 'Available'),
...
Could Samurai Cat be the missing piece in your family? Come meet them today!', 'Sweet-tempered, loyal, and thrives in a peaceful environment.', 'img/animals/cats/samurai_cat.png', 'Available'),
...
Is Scaredy Cat the furry friend you''ve been searching for? Apply to adopt today!', 'Playful, energetic, and loves interactive toys.', 'img/animals/cats/scaredy_cat.png', 'Available'),
...
Ready to welcome Sam into your life? Contact our adoption team now.', 'Playful, Goofy, High-energy (Mercenary<br>)', 'img/animals/cats/sam.png', 'Available'),
...
Selfie is dreaming of a cozy lap and plenty of treats in a quiet, loving home.', 'Affectionate, purr-heavy cuddlebug who loves head scratches.', 'img/animals/cats/selfie.png', 'Available'),
...
Sheriff Paw is ready to start their next chapter with a devoted family.', 'Curious, alert, and always exploring their surroundings.', 'img/animals/cats/sheriff_paw.png', 'Available'),
...
Come say hello to Slorphus and give this special pet the loving home they deserve.', 'Spirited, independent, but very loving with their favorite human.', 'img/animals/cats/slorphus.png', 'Available'),
...
Don''t miss the chance to bring Skeletus home—fill out an adoption inquiry today.', 'Mellow, relaxed, and great with cozy lap naps.', 'img/animals/cats/skeletus.png', 'Available'),
...
Give Sir Meows the fresh start they''ve been waiting for!', 'Social, confident, and eager to welcome visitors.', 'img/animals/cats/sir_meows.png', 'Available'),
...
So Silly would love to meet you—schedule a visit and fall in love!', 'Playful, Goofy, High-energy', 'img/animals/cats/so_silly.png', 'Available'),
...
Snuggles is up to date on vaccinations and ready to head home with you!', 'Sleepy, Cuddly, Mellow', 'img/animals/cats/snuggles.png', 'Available'),
...
Could Sora be the missing piece in your family? Come meet them today!', 'Gentle-natured, Kind-hearted, Affectionate', 'img/animals/cats/sora.png', 'Available'),
...
Is Spirte the furry friend you''ve been searching for? Apply to adopt today!', 'Playful, Goofy, High-energy (Delivery)', 'img/animals/cats/spirte.png', 'Available'),
...
Ready to welcome Strawberry Cat into your life? Contact our adoption team now.', 'Curious, alert, and always exploring their surroundings.', 'img/animals/cats/strawberry_cat.png', 'Available'),
...
Study Cat is dreaming of a cozy lap and plenty of treats in a quiet, loving home.', 'Spirited, independent, but very loving with their favorite human.', 'img/animals/cats/study_cat.png', 'Available'),
...
Tater Tot is ready to start their next chapter with a devoted family.', 'Mellow, relaxed, and great with cozy lap naps.', 'img/animals/cats/tater_tot.png', 'Available'),
...
Come say hello to Terrance and give this special pet the loving home they deserve.', 'Social, confident, and eager to welcome visitors.', 'img/animals/cats/terrance.png', 'Available'),
...
Don''t miss the chance to bring The Meeper home—fill out an adoption inquiry today.', 'Sleepy, Cuddly, Mellow (CEO)', 'img/animals/cats/the_meeper.png', 'Available'),
...
Give The kungus the fresh start they''ve been waiting for!', 'Playful, Goofy, High-energy', 'img/animals/cats/the_kungus.png', 'Available'),
...
The Fry Stealer would love to meet you—schedule a visit and fall in love!', 'Gentle, quiet, and enjoys lounging in sunny spots.', 'img/animals/cats/the_fry_stealer.png', 'Available'),
...
The Pizzer is up to date on vaccinations and ready to head home with you!', 'Playful, Goofy, High-energy', 'img/animals/cats/the_pizzer.png', 'Available'),
...
Could The Teefer be the missing piece in your family? Come meet them today!', 'Curious, alert, and always exploring their surroundings.', 'img/animals/cats/the_teefer.png', 'Available'),
...
Is The Sitter the furry friend you''ve been searching for? Apply to adopt today!', 'Spirited, independent, but very loving with their favorite human.', 'img/animals/cats/the_sitter.png', 'Available'),
...
Ready to welcome The One Of Them into your life? Contact our adoption team now.', 'Playful, Goofy, High-energy (Being one of them)', 'img/animals/cats/the_one_of_them.png', 'Available'),
...
Thurston Waffles is dreaming of a cozy lap and plenty of treats in a quiet, loving home.', 'Social, confident, and eager to welcome visitors.', 'img/animals/cats/thurston_waffles.png', 'Available'),
...
Tim Tim is ready to start their next chapter with a devoted family.', 'Sweet-tempered, loyal, and thrives in a peaceful environment.', 'img/animals/cats/tim_tim.png', 'Available'),
...
Come say hello to Uncle and give this special pet the loving home they deserve.', 'Charismatic, Confident, Leader (Music making, mafia boss (Previously))', 'img/animals/cats/uncle.png', 'Available'),
...
Don''t miss the chance to bring Vampirius home—fill out an adoption inquiry today.', 'Gentle, quiet, and enjoys lounging in sunny spots.', 'img/animals/cats/vampirius.png', 'Available'),
...
Give Unknown the fresh start they''ve been waiting for!', 'Affectionate, purr-heavy cuddlebug who loves head scratches.', 'img/animals/cats/unknown.png', 'Available'),
...
Tole Tole would love to meet you—schedule a visit and fall in love!', 'Curious, alert, and always exploring their surroundings.', 'img/animals/cats/tole_tole.gif', 'Available'),
...
Toby is up to date on vaccinations and ready to head home with you!', 'Playful, Goofy, High-energy (Community Companion)', 'img/animals/cats/toby.png', 'Available'),
...
Could Wagoogus Jr. be the missing piece in your family? Come meet them today!', 'Playful, Goofy, High-energy (Being a little fella)', 'img/animals/cats/wagoogus_jr.png', 'Available'),
...
Is Wilbert the furry friend you''ve been searching for? Apply to adopt today!', 'Sleepy, Cuddly, Mellow', 'img/animals/cats/wilbert.png', 'Available'),
...
Ready to welcome Watermelon Cat into your life? Contact our adoption team now.', 'Sweet-tempered, loyal, and thrives in a peaceful environment.', 'img/animals/cats/watermelon_cat.png', 'Available'),
...
Wild Pete is dreaming of a cozy lap and plenty of treats in a quiet, loving home.', 'Playful, energetic, and loves interactive toys.', 'img/animals/cats/wild_pete.png', 'Available'),
...
Wire Cat is ready to start their next chapter with a devoted family.', 'Gentle, quiet, and enjoys lounging in sunny spots.', 'img/animals/cats/wire_cat.png', 'Available'),
...
Come say hello to Wit Kit and give this special pet the loving home they deserve.', 'Playful, Goofy, High-energy', 'img/animals/cats/wit_kit.png', 'Available'),
...
Don''t miss the chance to bring Xiaojie home—fill out an adoption inquiry today.', 'Playful, Goofy, High-energy', 'img/animals/cats/xiaojie.png', 'Available'),
...
Give Wisp the fresh start they''ve been waiting for!', 'Spirited, independent, but very loving with their favorite human.', 'img/animals/cats/wisp.png', 'Available'),
(158, 'Wizard of Spells', 2, 13, 4, 'Ready to open your heart? Wizard of Spells is waiting to meet their forever family.

Wizard of Spells

Wizard of Spells would love to meet you—schedule a visit and fall in love!', 'Playful, Goofy, High-energy', 'img/animals/cats/wizard_of_spells.png', 'Available'),
...
Zim Zorp is up to date on vaccinations and ready to head home with you!', 'Sleepy, Cuddly, Mellow', 'img/animals/cats/zim_zorp.png', 'Available'),
...
Could Xorgus be the missing piece in your family? Come meet them today!', 'Sweet-tempered, loyal, and thrives in a peaceful environment.', 'img/animals/cats/xorgus.png', 'Available'),
...
Is Bathder the furry friend you''ve been searching for? Apply to adopt today!', 'Playful, energetic, and loves interactive toys.', 'img/animals/cats/glooble.jpg', 'Available');
