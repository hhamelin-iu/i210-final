...
Is Almano the furry friend you''ve been searching for? Apply to adopt today!', 'Playful, energetic, and loves interactive toys.', 'www/img/animals/glooble.jpg', 'Available'),
...
Ready to welcome Ah So Cat into your life? Contact our adoption team now.', 'Gentle, quiet, and enjoys lounging in sunny spots.', 'www/img/animals/ah_so_cat.png', 'Available'),
...
Artyom is dreaming of a cozy lap and plenty of treats in a quiet, loving home.', 'Playful, Goofy, High-energy', 'www/img/animals/artyom.png', 'Available'),
...
Angelina is ready to start their next chapter with a devoted family.', 'Curious, alert, and always exploring their surroundings.', 'www/img/animals/angelina.png', 'Available'),
...
Come say hello to Aoba and give this special pet the loving home they deserve.', 'Gentle-natured, Kind-hearted, Affectionate', 'www/img/animals/aoba.png', 'Available'),
...
Don''t miss the chance to bring Baguette Dude home—fill out an adoption inquiry today.', 'Mellow, relaxed, and great with cozy lap naps.', 'www/img/animals/baguette_dude.png', 'Available'),
...
Give Baskit Cat the fresh start they''ve been waiting for!', 'Social, confident, and eager to welcome visitors.', 'www/img/animals/baskit_cat.png', 'Available'),
...
Bat Cat would love to meet you—schedule a visit and fall in love!', 'Sweet-tempered, loyal, and thrives in a peaceful environment.', 'www/img/animals/bat_cat.png', 'Available'),
...
Big Billy is up to date on vaccinations and ready to head home with you!', 'Gentle-natured, Kind-hearted, Affectionate', 'www/img/animals/big_billy.png', 'Available'),
...
Could Ben be the missing piece in your family? Come meet them today!', 'Gentle-natured, Kind-hearted, Affectionate', 'www/img/animals/ben.png', 'Available'),
...
Is Bentley the furry friend you''ve been searching for? Apply to adopt today!', 'Gentle-natured, Kind-hearted, Affectionate (Farming)', 'www/img/animals/bentley.png', 'Available'),
...
Ready to welcome Bernard into your life? Contact our adoption team now.', 'Playful, Goofy, High-energy', 'www/img/animals/bernard.png', 'Available'),
...
Bb is dreaming of a cozy lap and plenty of treats in a quiet, loving home.', 'Spirited, independent, but very loving with their favorite human.', 'www/img/animals/bb.png', 'Available'),
...
Billy is ready to start their next chapter with a devoted family.', 'Mellow, relaxed, and great with cozy lap naps.', 'www/img/animals/billy.png', 'Available'),
...
Come say hello to Bingus and give this special pet the loving home they deserve.', 'Social, confident, and eager to welcome visitors.', 'www/img/animals/bingus.png', 'Available'),
...
Don''t miss the chance to bring BOB of Bobstein home—fill out an adoption inquiry today.', 'Sweet-tempered, loyal, and thrives in a peaceful environment.', 'www/img/animals/glooble.jpg', 'Available'),
...
Give Bingus/Bingus the II the fresh start they''ve been waiting for!', 'Gentle-natured, Kind-hearted, Affectionate', 'www/img/animals/bingus_bingus_the_ii.png', 'Available'),
...
Bleg would love to meet you—schedule a visit and fall in love!', 'Gentle-natured, Kind-hearted, Affectionate', 'www/img/animals/bleg.png', 'Available'),
...
Bleemk is up to date on vaccinations and ready to head home with you!', 'Affectionate, purr-heavy cuddlebug who loves head scratches.', 'www/img/animals/bleemk.png', 'Available'),
...
Could Bob be the missing piece in your family? Come meet them today!', 'Curious, alert, and always exploring their surroundings.', 'www/img/animals/bob.png', 'Available'),
(21, 'Bounty hunter cat', 2, 12, 7, 'Looking for a cuddle buddy? Bounty hunter cat might just be your perfect match!

Bounty hunter cat

Is Bounty hunter cat the furry friend you''ve been searching for? Apply to adopt today!', 'Spirited, independent, but very loving with their favorite human.', 'www/img/animals/bounty_hunter_cat.png', 'Available'),
...
Ready to welcome Brunnincast into your life? Contact our adoption team now.', 'Playful, Goofy, High-energy', 'www/img/animals/brunnincast.png', 'Available'),
...
Bubble Cat is dreaming of a cozy lap and plenty of treats in a quiet, loving home.', 'Social, confident, and eager to welcome visitors.', 'www/img/animals/bubble_cat.png', 'Available'),
...
Buck is ready to start their next chapter with a devoted family.', 'Sweet-tempered, loyal, and thrives in a peaceful environment.', 'www/img/animals/buck.png', 'Available'),
...
Come say hello to Bungus and give this special pet the loving home they deserve.', 'Playful, Goofy, High-energy (Judging who goes to heck and who goes to not heck<br>)', 'www/img/animals/bungus.png', 'Available'),
...
Don''t miss the chance to bring Cala home—fill out an adoption inquiry today.', 'Gentle, quiet, and enjoys lounging in sunny spots.', 'www/img/animals/cala.png', 'Available'),
...
Give Cheeseburger the fresh start they''ve been waiting for!', 'Affectionate, purr-heavy cuddlebug who loves head scratches.', 'www/img/animals/cheeseburger.png', 'Available'),
...
Cement Joe would love to meet you—schedule a visit and fall in love!', 'Curious, alert, and always exploring their surroundings.', 'www/img/animals/cement_joe.png', 'Available'),
(29, 'Canela', 2, 13, 7, 'Canela is a precious soul ready for their next big chapter in a forever home.

- EtharViolo Canela

Canela is up to date on vaccinations and ready to head home with you!', 'Spirited, independent, but very loving with their favorite human.', 'www/img/animals/canela.png', 'Available'),
...
Could Chipi Chipi Chapa Chapa Cat be the missing piece in your family? Come meet them today!', 'Mellow, relaxed, and great with cozy lap naps.', 'www/img/animals/chipi_chipi_chapa_chapa_cat.png', 'Available'),
...
Is Cokey Cola the furry friend you''ve been searching for? Apply to adopt today!', 'Social, confident, and eager to welcome visitors.', 'www/img/animals/cokey_cola.png', 'Available'),
...
Ready to welcome Cuh into your life? Contact our adoption team now.', 'Sweet-tempered, loyal, and thrives in a peaceful environment.', 'www/img/animals/cuh.png', 'Available'),
...
Deksy is dreaming of a cozy lap and plenty of treats in a quiet, loving home.', 'Playful, energetic, and loves interactive toys.', 'www/img/animals/deksy.png', 'Available'),
...
Demetrus P. Dinklebottom is ready to start their next chapter with a devoted family.', 'Charismatic, Confident, Leader (Crime Boss)', 'www/img/animals/demetrus_p__dinklebottom.png', 'Available'),
...
Come say hello to Cwawa and give this special pet the loving home they deserve.', 'Affectionate, purr-heavy cuddlebug who loves head scratches.', 'www/img/animals/cwawa.png', 'Available'),
...
Don''t miss the chance to bring Demon Cat home—fill out an adoption inquiry today.', 'Playful, Goofy, High-energy', 'www/img/animals/demon_cat.png', 'Available'),
...
Give Demonic Little Grey Cat the fresh start they''ve been waiting for!', 'Gentle-natured, Kind-hearted, Affectionate', 'www/img/animals/demonic_little_grey_cat.png', 'Available'),
(38, 'Dietzen D. Dinklebottom', 2, 9, 6, 'Give a warm welcome to Dietzen D. Dinklebottom, an adventurous and spirited friend.

Dinklebottom

Dietzen D. Dinklebottom would love to meet you—schedule a visit and fall in love!', 'Mellow, relaxed, and great with cozy lap naps.', 'www/img/animals/dietzen_d__dinklebottom.png', 'Available'),
(39, 'Dmitri', 2, 8, 2, 'Dmitri is ready to make your house feel like home.

Diechmen Family Vampirius Dmitri Skeletus Ramses Dmitri

Dmitri is up to date on vaccinations and ready to head home with you!', 'Social, confident, and eager to welcome visitors.', 'www/img/animals/dmitri.png', 'Available'),
...
Could Doobis be the missing piece in your family? Come meet them today!', 'Sweet-tempered, loyal, and thrives in a peaceful environment.', 'www/img/animals/doobis.png', 'Available'),
...
Is Dr Pebba the furry friend you''ve been searching for? Apply to adopt today!', 'Playful, energetic, and loves interactive toys.', 'www/img/animals/dr_pebba.png', 'Available'),
...
Ready to welcome Dr Peppy into your life? Contact our adoption team now.', 'Gentle, quiet, and enjoys lounging in sunny spots.', 'www/img/animals/dr_peppy.png', 'Available'),
...
Drefis is dreaming of a cozy lap and plenty of treats in a quiet, loving home.', 'Affectionate, purr-heavy cuddlebug who loves head scratches.', 'www/img/animals/drefis.png', 'Available'),
...
Dr. Silly Willy is ready to start their next chapter with a devoted family.', 'Playful, Goofy, High-energy', 'www/img/animals/dr__silly_willy.png', 'Available'),
...
Come say hello to Doudou(Oye) and give this special pet the loving home they deserve.', 'Playful, Goofy, High-energy', 'www/img/animals/doudou_oye.png', 'Available'),
(46, 'Drazy Cat', 2, 14, 2, 'Ready to open your heart? Drazy Cat is waiting to meet their forever family.

Drazy Cat nation

Don''t miss the chance to bring Drazy Cat home—fill out an adoption inquiry today.', 'Mellow, relaxed, and great with cozy lap naps.', 'www/img/animals/drazy_cat.png', 'Available'),
...
Give El Gato the fresh start they''ve been waiting for!', 'Social, confident, and eager to welcome visitors.', 'www/img/animals/el_gato.png', 'Available'),
...
E. Scrunk would love to meet you—schedule a visit and fall in love!', 'Sweet-tempered, loyal, and thrives in a peaceful environment.', 'www/img/animals/e__scrunk.png', 'Available'),
...
Edward is up to date on vaccinations and ready to head home with you!', 'Playful, energetic, and loves interactive toys.', 'www/img/animals/edward.png', 'Available'),
...
Could Eepeer (Endless Eeps) be the missing piece in your family? Come meet them today!', 'Sleepy, Cuddly, Mellow', 'www/img/animals/eepeer__endless_eeps.png', 'Available'),
...
Is Evil Cat the furry friend you''ve been searching for? Apply to adopt today!', 'Gentle-natured, Kind-hearted, Affectionate (Community Companion)', 'www/img/animals/evil_cat.png', 'Available'),
...
Ready to welcome Ernesto into your life? Contact our adoption team now.', 'Curious, alert, and always exploring their surroundings.', 'www/img/animals/ernesto.png', 'Available'),
...
Ethel the Cat is dreaming of a cozy lap and plenty of treats in a quiet, loving home.', 'Playful, Goofy, High-energy', 'www/img/animals/ethel_the_cat.png', 'Available'),
...
Fanter is ready to start their next chapter with a devoted family.', 'Mellow, relaxed, and great with cozy lap naps.', 'www/img/animals/fanter.png', 'Available'),
...
Come say hello to Ferret and give this special pet the loving home they deserve.', 'Social, confident, and eager to welcome visitors.', 'www/img/animals/ferret.png', 'Available'),
...
Don''t miss the chance to bring Eyebrow home—fill out an adoption inquiry today.', 'Sweet-tempered, loyal, and thrives in a peaceful environment.', 'www/img/animals/eyebrow.png', 'Available'),
...
Give Floppa the fresh start they''ve been waiting for!', 'Gentle-natured, Kind-hearted, Affectionate (Community Companion)', 'www/img/animals/floppa.png', 'Available'),
(58, 'Ethan', 2, 7, 7, 'Ethan has arrived at the shelter and is eager to meet their new best friend.

Ethan muehehe...

Ethan would love to meet you—schedule a visit and fall in love!', 'Playful, Goofy, High-energy', 'www/img/animals/ethan.png', 'Available'),
...
Future Kitty is up to date on vaccinations and ready to head home with you!', 'Gentle-natured, Kind-hearted, Affectionate (Time Traveling<br>)', 'www/img/animals/future_kitty.png', 'Available'),
...
Could Gentleman be the missing piece in your family? Come meet them today!', 'Charismatic, Confident, Leader', 'www/img/animals/gentleman.png', 'Available'),
...
Is Gangster bob the furry friend you''ve been searching for? Apply to adopt today!', 'Playful, Goofy, High-energy', 'www/img/animals/gangster_bob.png', 'Available'),
...
Ready to welcome Geeble into your life? Contact our adoption team now.', 'Playful, Goofy, High-energy (Being an alien doing alien things.)', 'www/img/animals/geeble.png', 'Available'),
(63, 'Glombie', 2, 16, 4, 'Glombie is an extraordinary pet with a story to tell and plenty of love to give.

Glombie is a sweet, playful cat looking for a warm and comfortable home to settle down in.

Glombie is dreaming of a cozy lap and plenty of treats in a quiet, loving home.', 'Social, confident, and eager to welcome visitors.', 'www/img/animals/glombie.png', 'Available'),
...
Fouet is ready to start their next chapter with a devoted family.', 'Gentle-natured, Kind-hearted, Affectionate', 'www/img/animals/fouet.png', 'Available'),
...
Come say hello to Gloober and give this special pet the loving home they deserve.', 'Playful, Goofy, High-energy', 'www/img/animals/gloober.png', 'Available'),
...
Don''t miss the chance to bring Glungus home—fill out an adoption inquiry today.', 'Gentle, quiet, and enjoys lounging in sunny spots.', 'www/img/animals/glungus.png', 'Available'),
...
Give Glorpo the fresh start they''ve been waiting for!', 'Playful, Goofy, High-energy', 'www/img/animals/glorpo.png', 'Available'),
...
Gnapy would love to meet you—schedule a visit and fall in love!', 'Curious, alert, and always exploring their surroundings.', 'www/img/animals/gnapy.png', 'Available'),
...
Glooble is up to date on vaccinations and ready to head home with you!', 'Spirited, independent, but very loving with their favorite human.', 'www/img/animals/glooble.png', 'Available'),
...
Could Goga Cat be the missing piece in your family? Come meet them today!', 'Charismatic, Confident, Leader', 'www/img/animals/goga_cat.png', 'Available'),
(71, 'Goober the Eighth', 2, 13, 4, 'Goober the Eighth is ready to make your house feel like home.

Goober the Eighth

Is Goober the Eighth the furry friend you''ve been searching for? Apply to adopt today!', 'Social, confident, and eager to welcome visitors.', 'www/img/animals/goober_the_eighth.png', 'Available'),
(72, 'Goober the Fifth', 2, 13, 5, 'If you''re seeking a loyal and affectionate partner, look no further than Goober the Fifth.

Goober the fifth

Ready to welcome Goober the Fifth into your life? Contact our adoption team now.', 'Playful, Goofy, High-energy', 'www/img/animals/goober_the_fifth.png', 'Available'),
...
Goober the Ninth is dreaming of a cozy lap and plenty of treats in a quiet, loving home.', 'Playful, energetic, and loves interactive toys.', 'www/img/animals/goober_the_ninth.png', 'Available'),
...
Goofus is ready to start their next chapter with a devoted family.', 'Gentle, quiet, and enjoys lounging in sunny spots.', 'www/img/animals/goofus.png', 'Available'),
(75, 'Goober the Third', 2, 13, 1, 'With a majestic presence and a gentle heart, Goober the Third is waiting for you.

Goober the Third

Come say hello to Goober the Third and give this special pet the loving home they deserve.', 'Affectionate, purr-heavy cuddlebug who loves head scratches.', 'www/img/animals/goober_the_third.png', 'Available'),
(76, 'Goober the Fourth', 2, 10, 7, 'Say hi to Goober the Fourth, a delightful pet who loves making new friends.

Goober the Fourth

Don''t miss the chance to bring Goober the Fourth home—fill out an adoption inquiry today.', 'Curious, alert, and always exploring their surroundings.', 'www/img/animals/goober_the_fourth.png', 'Available'),
(77, 'Goober the Second', 2, 2, 7, 'Goober the Second is a precious soul ready for their next big chapter in a forever home.

Goober the Second

Give Goober the Second the fresh start they''ve been waiting for!', 'Spirited, independent, but very loving with their favorite human.', 'www/img/animals/goober_the_second.png', 'Available'),
(78, 'Goober the Sixth', 2, 13, 1, 'Ready to open your heart? Goober the Sixth is waiting to meet their forever family.

Goober the Sixth

Goober the Sixth would love to meet you—schedule a visit and fall in love!', 'Mellow, relaxed, and great with cozy lap naps.', 'www/img/animals/goober_the_sixth.png', 'Available'),
(79, 'Goober the Tenth', 2, 15, 2, 'Goober the Tenth is an extraordinary pet with a story to tell and plenty of love to give.

Goober the Tenth

Goober the Tenth is up to date on vaccinations and ready to head home with you!', 'Social, confident, and eager to welcome visitors.', 'www/img/animals/goober_the_tenth.png', 'Available'),
...
Could Grinwatcher/Underling be the missing piece in your family? Come meet them today!', 'Sweet-tempered, loyal, and thrives in a peaceful environment.', 'www/img/animals/grinwatcher_underling.png', 'Available'),
...
Is Grinwatcher the furry friend you''ve been searching for? Apply to adopt today!', 'Playful, Goofy, High-energy (Community Companion)', 'www/img/animals/grinwatcher.png', 'Available'),
...
Ready to welcome Grumpy Cat into your life? Contact our adoption team now.', 'Playful, Goofy, High-energy (Thinking)', 'www/img/animals/grumpy_cat.png', 'Available'),
...
Happy Cat is dreaming of a cozy lap and plenty of treats in a quiet, loving home.', 'Affectionate, purr-heavy cuddlebug who loves head scratches.', 'www/img/animals/happy_cat.png', 'Available'),
...
Grinwatcher/Right Hand Smiles is ready to start their next chapter with a devoted family.', 'Curious, alert, and always exploring their surroundings.', 'www/img/animals/grinwatcher_right_hand_smiles.png', 'Available'),
...
Come say hello to Gusic and give this special pet the loving home they deserve.', 'Spirited, independent, but very loving with their favorite human.', 'www/img/animals/gusic.png', 'Available'),
...
Don''t miss the chance to bring Herbert home—fill out an adoption inquiry today.', 'Mellow, relaxed, and great with cozy lap naps.', 'www/img/animals/herbert.png', 'Available'),
...
Give Hu Cat the fresh start they''ve been waiting for!', 'Social, confident, and eager to welcome visitors.', 'www/img/animals/hu_cat.png', 'Available'),
...
Jocelin would love to meet you—schedule a visit and fall in love!', 'Sweet-tempered, loyal, and thrives in a peaceful environment.', 'www/img/animals/jocelin.png', 'Available'),
...
Insam is up to date on vaccinations and ready to head home with you!', 'Playful, Goofy, High-energy (Archrival)', 'www/img/animals/insam.png', 'Available'),
...
Could Juice Cat be the missing piece in your family? Come meet them today!', 'Charismatic, Confident, Leader', 'www/img/animals/juice_cat.png', 'Available'),
...
Is Larry the furry friend you''ve been searching for? Apply to adopt today!', 'Gentle-natured, Kind-hearted, Affectionate', 'www/img/animals/larry.png', 'Available'),
...
Ready to welcome Kiw into your life? Contact our adoption team now.', 'Playful, Goofy, High-energy (Community Companion)', 'www/img/animals/kiw.png', 'Available'),
...
Kyky is dreaming of a cozy lap and plenty of treats in a quiet, loving home.', 'Playful, Goofy, High-energy', 'www/img/animals/kyky.png', 'Available'),
...
Limecat is ready to start their next chapter with a devoted family.', 'Gentle-natured, Kind-hearted, Affectionate', 'www/img/animals/limecat.png', 'Available'),
...
Come say hello to Juju Nugget and give this special pet the loving home they deserve.', 'Sleepy, Cuddly, Mellow', 'www/img/animals/juju_nugget.png', 'Available'),
...
Don''t miss the chance to bring Luna the Tabby home—fill out an adoption inquiry today.', 'Sweet-tempered, loyal, and thrives in a peaceful environment.', 'www/img/animals/luna_the_tabby.png', 'Available'),
...
Give Leonard the fresh start they''ve been waiting for!', 'Playful, Goofy, High-energy', 'www/img/animals/leonard.png', 'Available'),
...
Maxwell would love to meet you—schedule a visit and fall in love!', 'Gentle-natured, Kind-hearted, Affectionate (Community Companion)', 'www/img/animals/maxwell.png', 'Available'),
...
Meevin is up to date on vaccinations and ready to head home with you!', 'Affectionate, purr-heavy cuddlebug who loves head scratches.', 'www/img/animals/meevin.png', 'Available'),
...
Could Monsert be the missing piece in your family? Come meet them today!', 'Curious, alert, and always exploring their surroundings.', 'www/img/animals/monsert.png', 'Available'),
...
Is Nilbert the furry friend you''ve been searching for? Apply to adopt today!', 'Spirited, independent, but very loving with their favorite human.', 'www/img/animals/nilbert.png', 'Available'),
...
Ready to welcome Neeble into your life? Contact our adoption team now.', 'Mellow, relaxed, and great with cozy lap naps.', 'www/img/animals/neeble.png', 'Available'),
...
Mrs. Pringleton is dreaming of a cozy lap and plenty of treats in a quiet, loving home.', 'Gentle-natured, Kind-hearted, Affectionate', 'www/img/animals/mrs__pringleton.png', 'Available'),
(104, 'Panko', 2, 14, 2, 'If you''re seeking a loyal and affectionate partner, look no further than Panko.

Description [ ] Panko

Panko is ready to start their next chapter with a devoted family.', 'Sweet-tempered, loyal, and thrives in a peaceful environment.', 'www/img/animals/panko.png', 'Available'),
...
Come say hello to Pepsie and give this special pet the loving home they deserve.', 'Playful, Goofy, High-energy (Delivery)', 'www/img/animals/pepsie.png', 'Available'),
...
Don''t miss the chance to bring Photosynthesizing home—fill out an adoption inquiry today.', 'Gentle, quiet, and enjoys lounging in sunny spots.', 'www/img/animals/photosynthesizing.png', 'Available'),
...
Give Pobis the fresh start they''ve been waiting for!', 'Playful, Goofy, High-energy', 'www/img/animals/pobis.png', 'Available'),
...
Poncky would love to meet you—schedule a visit and fall in love!', 'Curious, alert, and always exploring their surroundings.', 'www/img/animals/poncky.png', 'Available'),
...
Potato is up to date on vaccinations and ready to head home with you!', 'Spirited, independent, but very loving with their favorite human.', 'www/img/animals/potato.png', 'Available'),
(110, 'Prince bingulius', 2, 8, 3, 'Ready to open your heart? Prince bingulius is waiting to meet their forever family.

Prince Bingulius

Could Prince bingulius be the missing piece in your family? Come meet them today!', 'Charismatic, Confident, Leader', 'www/img/animals/prince_bingulius.png', 'Available'),
...
Is Pusha the furry friend you''ve been searching for? Apply to adopt today!', 'Social, confident, and eager to welcome visitors.', 'www/img/animals/pusha.png', 'Available'),
...
Ready to welcome Prongles into your life? Contact our adoption team now.', 'Playful, Goofy, High-energy (Failing to obey factory rule)', 'www/img/animals/prongles.png', 'Available'),
...
Quetzkol The Incomprehensible Deity is dreaming of a cozy lap and plenty of treats in a quiet, loving home.', 'Playful, Goofy, High-energy (Being Incomprehensible)', 'www/img/animals/quetzkol_the_incomprehensible_deity.png', 'Available'),
...
Radio Cat is ready to start their next chapter with a devoted family.', 'Playful, Goofy, High-energy', 'www/img/animals/radio_cat.png', 'Available'),
...
Come say hello to Ramses and give this special pet the loving home they deserve.', 'Affectionate, purr-heavy cuddlebug who loves head scratches.', 'www/img/animals/ramses.png', 'Available'),
...
Don''t miss the chance to bring Sandwich home—fill out an adoption inquiry today.', 'Playful, Goofy, High-energy (Community Companion)', 'www/img/animals/sandwich.png', 'Available'),
...
Give Rigby the fresh start they''ve been waiting for!', 'Gentle-natured, Kind-hearted, Affectionate', 'www/img/animals/rigby.png', 'Available'),
...
Roobeer would love to meet you—schedule a visit and fall in love!', 'Mellow, relaxed, and great with cozy lap naps.', 'www/img/animals/roobeer.png', 'Available'),
...
Richer Motion is up to date on vaccinations and ready to head home with you!', 'Social, confident, and eager to welcome visitors.', 'www/img/animals/richer_motion.png', 'Available'),
...
Could Samurai Cat be the missing piece in your family? Come meet them today!', 'Sweet-tempered, loyal, and thrives in a peaceful environment.', 'www/img/animals/samurai_cat.png', 'Available'),
...
Is Scaredy Cat the furry friend you''ve been searching for? Apply to adopt today!', 'Playful, energetic, and loves interactive toys.', 'www/img/animals/scaredy_cat.png', 'Available'),
...
Ready to welcome Sam into your life? Contact our adoption team now.', 'Playful, Goofy, High-energy (Mercenary<br>)', 'www/img/animals/sam.png', 'Available'),
...
Selfie is dreaming of a cozy lap and plenty of treats in a quiet, loving home.', 'Affectionate, purr-heavy cuddlebug who loves head scratches.', 'www/img/animals/selfie.png', 'Available'),
...
Sheriff Paw is ready to start their next chapter with a devoted family.', 'Curious, alert, and always exploring their surroundings.', 'www/img/animals/sheriff_paw.png', 'Available'),
...
Come say hello to Slorphus and give this special pet the loving home they deserve.', 'Spirited, independent, but very loving with their favorite human.', 'www/img/animals/slorphus.png', 'Available'),
...
Don''t miss the chance to bring Skeletus home—fill out an adoption inquiry today.', 'Mellow, relaxed, and great with cozy lap naps.', 'www/img/animals/skeletus.png', 'Available'),
...
Give Sir Meows the fresh start they''ve been waiting for!', 'Social, confident, and eager to welcome visitors.', 'www/img/animals/sir_meows.png', 'Available'),
...
So Silly would love to meet you—schedule a visit and fall in love!', 'Playful, Goofy, High-energy', 'www/img/animals/so_silly.png', 'Available'),
...
Snuggles is up to date on vaccinations and ready to head home with you!', 'Sleepy, Cuddly, Mellow', 'www/img/animals/snuggles.png', 'Available'),
...
Could Sora be the missing piece in your family? Come meet them today!', 'Gentle-natured, Kind-hearted, Affectionate', 'www/img/animals/sora.png', 'Available'),
...
Is Spirte the furry friend you''ve been searching for? Apply to adopt today!', 'Playful, Goofy, High-energy (Delivery)', 'www/img/animals/spirte.png', 'Available'),
...
Ready to welcome Strawberry Cat into your life? Contact our adoption team now.', 'Curious, alert, and always exploring their surroundings.', 'www/img/animals/strawberry_cat.png', 'Available'),
...
Study Cat is dreaming of a cozy lap and plenty of treats in a quiet, loving home.', 'Spirited, independent, but very loving with their favorite human.', 'www/img/animals/study_cat.png', 'Available'),
...
Tater Tot is ready to start their next chapter with a devoted family.', 'Mellow, relaxed, and great with cozy lap naps.', 'www/img/animals/tater_tot.png', 'Available'),
...
Come say hello to Terrance and give this special pet the loving home they deserve.', 'Social, confident, and eager to welcome visitors.', 'www/img/animals/terrance.png', 'Available'),
...
Don''t miss the chance to bring The Meeper home—fill out an adoption inquiry today.', 'Sleepy, Cuddly, Mellow (CEO)', 'www/img/animals/the_meeper.png', 'Available'),
...
Give The kungus the fresh start they''ve been waiting for!', 'Playful, Goofy, High-energy', 'www/img/animals/the_kungus.png', 'Available'),
...
The Fry Stealer would love to meet you—schedule a visit and fall in love!', 'Gentle, quiet, and enjoys lounging in sunny spots.', 'www/img/animals/the_fry_stealer.png', 'Available'),
...
The Pizzer is up to date on vaccinations and ready to head home with you!', 'Playful, Goofy, High-energy', 'www/img/animals/the_pizzer.png', 'Available'),
...
Could The Teefer be the missing piece in your family? Come meet them today!', 'Curious, alert, and always exploring their surroundings.', 'www/img/animals/the_teefer.png', 'Available'),
...
Is The Sitter the furry friend you''ve been searching for? Apply to adopt today!', 'Spirited, independent, but very loving with their favorite human.', 'www/img/animals/the_sitter.png', 'Available'),
...
Ready to welcome The One Of Them into your life? Contact our adoption team now.', 'Playful, Goofy, High-energy (Being one of them)', 'www/img/animals/the_one_of_them.png', 'Available'),
...
Thurston Waffles is dreaming of a cozy lap and plenty of treats in a quiet, loving home.', 'Social, confident, and eager to welcome visitors.', 'www/img/animals/thurston_waffles.png', 'Available'),
...
Tim Tim is ready to start their next chapter with a devoted family.', 'Sweet-tempered, loyal, and thrives in a peaceful environment.', 'www/img/animals/tim_tim.png', 'Available'),
...
Come say hello to Uncle and give this special pet the loving home they deserve.', 'Charismatic, Confident, Leader (Music making, mafia boss (Previously))', 'www/img/animals/uncle.png', 'Available'),
...
Don''t miss the chance to bring Vampirius home—fill out an adoption inquiry today.', 'Gentle, quiet, and enjoys lounging in sunny spots.', 'www/img/animals/vampirius.png', 'Available'),
...
Give Unknown the fresh start they''ve been waiting for!', 'Affectionate, purr-heavy cuddlebug who loves head scratches.', 'www/img/animals/unknown.png', 'Available'),
...
Tole Tole would love to meet you—schedule a visit and fall in love!', 'Curious, alert, and always exploring their surroundings.', 'www/img/animals/tole_tole.gif', 'Available'),
...
Toby is up to date on vaccinations and ready to head home with you!', 'Playful, Goofy, High-energy (Community Companion)', 'www/img/animals/toby.png', 'Available'),
...
Could Wagoogus Jr. be the missing piece in your family? Come meet them today!', 'Playful, Goofy, High-energy (Being a little fella)', 'www/img/animals/wagoogus_jr.png', 'Available'),
...
Is Wilbert the furry friend you''ve been searching for? Apply to adopt today!', 'Sleepy, Cuddly, Mellow', 'www/img/animals/wilbert.png', 'Available'),
...
Ready to welcome Watermelon Cat into your life? Contact our adoption team now.', 'Sweet-tempered, loyal, and thrives in a peaceful environment.', 'www/img/animals/watermelon_cat.png', 'Available'),
...
Wild Pete is dreaming of a cozy lap and plenty of treats in a quiet, loving home.', 'Playful, energetic, and loves interactive toys.', 'www/img/animals/wild_pete.png', 'Available'),
...
Wire Cat is ready to start their next chapter with a devoted family.', 'Gentle, quiet, and enjoys lounging in sunny spots.', 'www/img/animals/wire_cat.png', 'Available'),
...
Come say hello to Wit Kit and give this special pet the loving home they deserve.', 'Playful, Goofy, High-energy', 'www/img/animals/wit_kit.png', 'Available'),
...
Don''t miss the chance to bring Xiaojie home—fill out an adoption inquiry today.', 'Playful, Goofy, High-energy', 'www/img/animals/xiaojie.png', 'Available'),
...
Give Wisp the fresh start they''ve been waiting for!', 'Spirited, independent, but very loving with their favorite human.', 'www/img/animals/wisp.png', 'Available'),
(158, 'Wizard of Spells', 2, 13, 4, 'Ready to open your heart? Wizard of Spells is waiting to meet their forever family.

Wizard of Spells

Wizard of Spells would love to meet you—schedule a visit and fall in love!', 'Playful, Goofy, High-energy', 'www/img/animals/wizard_of_spells.png', 'Available'),
...
Zim Zorp is up to date on vaccinations and ready to head home with you!', 'Sleepy, Cuddly, Mellow', 'www/img/animals/zim_zorp.png', 'Available'),
...
Could Xorgus be the missing piece in your family? Come meet them today!', 'Sweet-tempered, loyal, and thrives in a peaceful environment.', 'www/img/animals/xorgus.png', 'Available'),
...
Is Bathder the furry friend you''ve been searching for? Apply to adopt today!', 'Playful, energetic, and loves interactive toys.', 'www/img/animals/bathder.png', 'Available');
